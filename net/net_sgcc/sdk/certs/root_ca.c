...
char *iotx_ca_crt = NULL;

void IOT_SetRootCA(int type)
{
    const char *iotx_ca_crt_debug =
        {
    ...
    if (type == CA_FORMAL)
    {
        iotx_ca_crt = (char *)iotx_ca_crt_formal;
    }
    else
    {
        iotx_ca_crt = (char *)iotx_ca_crt_debug;
    }
}
