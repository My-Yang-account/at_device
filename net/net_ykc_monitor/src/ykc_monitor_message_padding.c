...
{
    uint8_t data_len = sizeof(Net_YkcMonitorPro_PRes_Query_PReq_Report_RealTimeData_t) + NET_YKC_MONITOR_PROTOCOL_CHECK_REGION_SIZE;
...
{
    uint8_t data_len = sizeof(Net_YkcMonitorPro_PRes_Remote_StopCharge_t) + NET_YKC_MONITOR_PROTOCOL_CHECK_REGION_SIZE;
...
{
    uint8_t data_len = sizeof(Net_YkcMonitorPro_PRes_AccountBallance_Update_t) + NET_YKC_MONITOR_PROTOCOL_CHECK_REGION_SIZE;
...
{
    uint8_t data_len = sizeof(Net_YkcMonitorPro_PRes_GroundLock_Lifting_t) + NET_YKC_MONITOR_PROTOCOL_CHECK_REGION_SIZE;
...
{
    uint8_t data_len = sizeof(Net_YkcMonitorPro_PRes_RemoteUpdate_t) + NET_YKC_MONITOR_PROTOCOL_CHECK_REGION_SIZE;
...
{
    uint8_t data_len = sizeof(Net_YkcMonitorPro_PRes_Remote_StartMergeCharge_t) + NET_YKC_MONITOR_PROTOCOL_CHECK_REGION_SIZE;
...
void ykc_monitor_chargepile_request_padding_bmscommand_chargerout(uint8_t gunno, uint8_t is_init)
{
    ...
    if(is_init){
        ...
        if(ykc_monitor_get_message_send_state(gunno, NET_YKC_MONITOR_PREQ_EVENT_CHARGER_OUTPUT_BMS_REQUIRE) == NET_YKC_MONITOR_SEND_STATE_COMPLETE){
            ...
            g_ykc_monitor_preq_bmscommand_chargerout[gunno].body.charge_time = s_ykc_monitor_base->charge_time;
        }
    }
}
...
uint8_t ykc_monitor_chargepile_request_padding_transaction_record(uint8_t gunno, void *transaction, uint8_t is_repeat)
{
    ...
    if((ykc_monitor_get_message_send_state(gunno, NET_YKC_MONITOR_PREQ_EVENT_TRANSACTION_RECORD) == NET_YKC_MONITOR_SEND_STATE_COMPLETE) || !is_repeat){
        ...
        g_ykc_monitor_preq_transaction_records[gunno].body.total_loss_elect = _transaction->total_loss_elect;
