...
#define NET_YKC_MONITOR_EXTERNAL_PREQ_EVENT_DEVICE_CHANGED           10   /* 充电桩监控外部触发请求事件：器件状态变化上报 */
...
#define NET_YKC_MONITOR_USER_PREQ_EVENT_REPORT_DEVICE_CHANGED        14   /* 充电桩监控请求事件：导引状态变化信息 */
