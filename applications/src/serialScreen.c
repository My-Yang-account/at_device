...
#define SERIALSCREEN_CONFIG_PAGE_MAX   46  // 屏幕页面总数
...
#else
#define SERIALSCREEN_CONFIG_PAGE_MAX   42  // 屏幕页面总数
#define SERIALSCREEN_PAGE_ITEM_MAX     54  // 屏幕每页信息项总数
